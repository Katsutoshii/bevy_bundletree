//! This example illustrates the various features of Bevy UI using bevy_bundletree::BundleTree.

use bevy::{
    a11y::{
        accesskit::{NodeBuilder, Role},
        AccessibilityNode,
    }, color::palettes::css::GREEN, input::mouse::{MouseScrollUnit, MouseWheel}, prelude::*, winit::WinitSettings
};
...
enum UiNode {
    Node(NodeBundle),
    Text(TextBundle),
    TextNode((NodeBundle, Text)),
    LabelText((TextBundle, Label)),
    AccessibilityLabelText((TextBundle, Label, AccessibilityNode)),
    AccessibilityScrollList((NodeBundle, ScrollingList, AccessibilityNode)),
    ImageNode((NodeBundle, UiImage)),
}
        ...
        NodeBundle {
            ...
            NodeBundle {
                ...
                ..default()
                    ...
                    // Text
                    BundleTree::new((TextBundle::from_section(
                        "Text Example",
                        TextStyle {
